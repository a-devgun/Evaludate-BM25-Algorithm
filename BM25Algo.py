...
def bm25(indexed_file, queries_file, results_file, q_size=100):
    ...
    print(temp_queries_list)
    # Extract the query and the query id
    ...
    for queryId, query in queries_list.items():
        ...
        query_results[queryId] = query_score
    ...
    for queryId, query_score in query_results.items():
